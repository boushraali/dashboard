...
##
route::get('/additems',[DashboardController::class,'displayadditems'])->name('additems');
...
route::get('/items',[ItemsController::class,'GetItem'])->name('item');
route::post('saved',[ItemsController::class,"SaveItems"])->name('saved');

route::get('/delet/{x}',[ItemsController::class,"delet"])->name('delet');
route::get('/edited/{x}',[ItemsController::class,'Edited'])->name('edited');
route::post('/updated',[ItemsController::class,"Updated"])->name('updated');